...
public class RestGame extends Game {
    protected static final Logger logger = LogManager.getLogger(RestGame.class.getSimpleName());

    public RestGame(Map<String, String> runningGameParametersMap, MainController controller) {
        super();
