...
public class ThrowingGame extends Game {
    protected static final Logger logger = LogManager.getLogger(ThrowingGame.class.getSimpleName());

    public ThrowingGame(Map<String, String> runningGameParametersMap, MainController controller) {
        super();
